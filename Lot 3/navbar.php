...
function renderNavbar($activePage) {
    ...
    if ($isConnected) {
        ...
        echo '<div class="nav-item ' . ($activePage === 'productlist' ? 'active' : '') . '" onclick="location.href=\'productlist.php\'"><span class="icon-circle"><img src="img/cottage_24dp_000000_FILL0_wght400_GRAD0_opsz24.svg"></span>Menu</div>';
